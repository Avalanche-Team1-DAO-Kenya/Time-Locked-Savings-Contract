...
var ConnectionController = {
  ...
  async reconnectExternal(options) {
    var _a5, _b3;
    await ((_b3 = (_a5 = this._getClient()).reconnectExternal) == null ? void 0 : _b3.call(_a5, options));
    StorageUtil.setConnectedConnector(options.type);
  },
...
var SwapCalculationUtil = {
  ...
  isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, balance) {
    var _a5, _b3;
    const sourceTokenBalance = (_b3 = (_a5 = balance == null ? void 0 : balance.find((token) => token.address === sourceTokenAddress)) == null ? void 0 : _a5.quantity) == null ? void 0 : _b3.numeric;
...
var SwapController = {
  ...
  getParams() {
    var _a5, _b3, _c, _d, _e, _f, _g, _h, _i;
    const { address } = AccountController.state;
    const networkAddress = `${(_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id}:${ConstantsUtil2.NATIVE_TOKEN_ADDRESS}`;
    if (!address) {
  ...
  async swapTokens() {
    ...
    const quoteToAmount = (_b3 = (_a5 = quoteResponse == null ? void 0 : quoteResponse.quotes) == null ? void 0 : _a5[0]) == null ? void 0 : _b3.toAmount;
    if (!quoteToAmount) {
      return;
    }
  ...
  async sendTransactionForSwap(data) {
    ...
    try {
      const successMessage = `Swapped ${(_a5 = state10.sourceToken) == null ? void 0 : _a5.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b3 = state10.toToken) == null ? void 0 : _b3.symbol}!`;
...
var AccountController = {
  ...
  setSocialWindow(socialWindow) {
    if (socialWindow) {
      state11.socialWindow = ref(socialWindow);
    }
  },
  async fetchTokenBalance() {
    var _a5;
    const chainId = (_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.id;
    try {
...
var ConnectorController = {
  ...
  addConnector(connector) {
    ...
    if (connector.id === "w3mAuth") {
      ...
      const themeVariables = ThemeController.getSnapshot().themeVariables;
      (_b3 = (_a5 = authConnector == null ? void 0 : authConnector.provider) == null ? void 0 : _a5.syncDappData) == null ? void 0 : _b3.call(_a5, {
  ...
  getAuthConnector() {
    return state14.connectors.find((c) => c.type === "AUTH");
  },
...
var SendController = {
  ...
  sendToken() {
    var _a5, _b3;
    if (((_a5 = this.state.token) == null ? void 0 : _a5.address) && this.state.sendTokenAmount && this.state.receiverAddress) {
      this.sendERC20Token({
...
var EnsController = {
  ...
  async resolveName(name) {
    ...
    try {
      ...
      const error = e;
      throw new Error(((_b3 = (_a5 = error == null ? void 0 : error.reasons) == null ? void 0 : _a5[0]) == null ? void 0 : _b3.description) || "Error resolving name");
    }
  },
  ...
  parseEnsApiError(error, defaultError) {
    ...
    return ((_b3 = (_a5 = ensError == null ? void 0 : ensError.reasons) == null ? void 0 : _a5[0]) == null ? void 0 : _b3.description) || defaultError;
  },
  isAllowedToRegisterName() {
    var _a5;
    const emailConnector = ConnectorController.getAuthConnector();
    const email = (emailConnector == null ? void 0 : emailConnector.provider.getEmail()) || "";
    const domain = (_a5 = email.split("@")) == null ? void 0 : _a5[1];
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5RGLIFIF.js.map
